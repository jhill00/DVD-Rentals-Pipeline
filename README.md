...
With all that said, here is a [diagram](https://github.com/jhill00/DataEng_DVDRentals/blob/main/database/dvdrental-ER_diagram-star_schema.pdf) of the DVD Rental store's database modeled to a star schema.